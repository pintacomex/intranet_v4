class AuthsRespuestasFile < ActiveRecord::Base
  attr_accessible :IdSolicitud, :IdRespuesta, :Usuario, :file

  has_attached_file :file, styles: { medium: "300x300>", thumb: "100x100>" }, default_url: "/auths_respuestas_files/:style/missing.png"
