class DocumentosFile < ActiveRecord::Base
  attr_accessible :CveAnt, :Clave, :file

  has_attached_file :file, styles: { medium: "300x300>", thumb: "100x100>" }, default_url: "/documentos_missing/:style/missing.png"
