class ComisionesPdf < Prawn::Document
	...
	def initialize(vendedor, nombre, mes, level, nombre_suc, objetivos, dias_transcurridos, categoria)
		...
		# if level == 1
		# 	place_text("Ventas proyectadas del vendedor para comisiones individuales:",30,109,11,80,5,'','L',4) 
		# 	place_text("#{number_to_currency(vendedor['NetasProyectadas'], :locale => :mx, :precision => 2)}",120,112,12,150,5,'','L',4)
		# end
